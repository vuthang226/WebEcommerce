...
using Web.Service.Catalog.Carts;
using Web.Service.Catalog.Categories;
using Web.Service.Catalog.Orders;
using Web.Service.Catalog.Products;
using Web.Service.System.Roles;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
               ...
               options.UseMySql(Configuration.GetConnectionString("WebDb"), new MySqlServerVersion(new Version(8, 0, 11))));
